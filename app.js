            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        <button class="btn btn-small btn-primary" onclick="app.addProductToBilling('${p.id}')" ${p.quantity === 0 ? 'disabled' : ''}>🛒 Add to Cart</button>
